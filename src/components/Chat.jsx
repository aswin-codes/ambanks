...
const Chat = () => {
  ...
  const connectWebSocket = () => {
    ...
    ws.current.onmessage = (event) => {
      const workerResponse = JSON.parse(event.data);
      addMessage(workerResponse.message, false);
      scrollToBottom();
    };
    ...
    if (newMessage) {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (botResponse === "I'm sorry, but I can't assist you at the moment.") {
            // If the response is undefined, send a message to the bank worker via WebSocket
